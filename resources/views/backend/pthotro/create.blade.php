...
@section('title', 'Thêm Phương Thức Hỗ Trợ Mới')
...
@section('content')
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Thêm Phương Thức Hỗ Trợ Mới</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-plus-circle"></i>
                Tạo phương thức hỗ trợ mới trong hệ thống
            </p>
        </div>
        </div>
    ...
    <div class="spa-content-wrapper">
        ...
        <div class="spa-content-body">
            <div class="spa-info-block">
                ...
                <p class="spa-info-block-text">
                    Tạo phương thức hỗ trợ mới để quản lý các hình thức hỗ trợ khách hàng. Hãy nhập mã phương thức và tên phương thức hỗ trợ.
                </p>
            </div>
        ...
        <!-- Form thêm phương thức -->
            <form action="{{ route('admin.pthotro.store') }}" method="POST" class="spa-form">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="MaPTHT" class="form-control" value="{{ old('MaPTHT') }}" required>
                            <div class="help-text">Nhập mã phương thức hỗ trợ (vd: PTHT001)</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="TenPT" class="form-control" value="{{ old('TenPT') }}" required>
