...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Xác Nhận Xóa Phương Thức Hỗ Trợ</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-exclamation-triangle"></i>
                Xóa phương thức hỗ trợ sẽ không thể hoàn tác
            </p>
        </div>
    </div>
    ...
    <div class="spa-content-wrapper">
        ...
        <div class="spa-content-body">
            <div class="spa-warning-card">
                <h3 class="spa-warning-title">
                    <i class="fas fa-exclamation-triangle"></i>
                    Cảnh Báo
                </h3>
                <p class="spa-warning-text">
                    Bạn đang chuẩn bị xóa phương thức hỗ trợ này. Hành động này không thể hoàn tác. Các dữ liệu liên quan đến phương thức hỗ trợ này cũng có thể bị ảnh hưởng.
                </p>
            </div>
            ...
            <div class="spa-info-card">
                ...
                <div class="spa-info-item">
                    ...
                    <span class="spa-info-value">{{ $pthotro->MaPTHT }}</span>
                </div>
                <div class="spa-info-item">
