...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">{{ $pthotro->TenPT }}</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-tag"></i>
                Mã phương thức: {{ $pthotro->MaPTHT }}
            </p>
        </div>
        <div class="spa-header-actions">
            ...
            <a href="{{ route('admin.pthotro.confirm-destroy', $pthotro->MaPTHT) }}" class="spa-action-btn delete" title="Xóa">
    ...
    <div class="spa-back-section">
        <a href="{{ route('admin.pthotro.index') }}" class="spa-back-btn">
                ...
                <div class="spa-content-body">
                    <div class="spa-info-card">
                        ...
                        <div class="spa-info-item">
                            <span class="spa-info-label">Mã Phương Thức:</span>
                            <span class="spa-info-value">
                                <span class="spa-info-badge badge-primary">{{ $pthotro->MaPTHT }}</span>
                            </span>
                        </div>
                        <div class="spa-info-item">
                            <span class="spa-info-label">Tên Phương Thức:</span>
                            <span class="spa-info-value">{{ $pthotro->TenPT }}</span>
                        </div>
                    </div>

                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.pthotro.edit', $pthotro->MaPTHT) }}" class="spa-btn spa-btn-primary">
                            <i class="fas fa-edit"></i>
                            Chỉnh Sửa
                        </a>
                        <a href="{{ route('admin.pthotro.confirm-destroy', $pthotro->MaPTHT) }}" class="spa-btn spa-btn-danger">
                            <i class="fas fa-trash"></i>
                            Xóa
                        </a>
                    </div>
            ...
            <div class="spa-content-wrapper">
                ...
                <div class="spa-content-body">
                    <div class="alert alert-info">
                        ...
                        <strong>Phương thức hỗ trợ</strong> là cách thức mà hệ thống cung cấp sự trợ giúp cho khách hàng. Phương thức hỗ trợ phổ biến bao gồm: hỗ trợ qua điện thoại, hỗ trợ trực tuyến, hỗ trợ qua email, hoặc hỗ trợ trực tiếp tại cơ sở.
                    </div>
                    <p class="mt-4">
                        Để tăng hiệu quả trong việc hỗ trợ khách hàng, bạn nên:
                    </p>
                    <ul>
                        <li>Đảm bảo mọi phương thức hỗ trợ đều hoạt động tốt</li>
                        <li>Cung cấp nhiều phương thức hỗ trợ khác nhau cho khách hàng lựa chọn</li>
                        <li>Đào tạo nhân viên để có thể hỗ trợ thông qua tất cả các phương thức</li>
                        <li>Theo dõi và cải thiện độ hài lòng của khách hàng với mỗi phương thức</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="spa-content-wrapper mb-4">
        ...
        <div class="spa-content-body">
            <div class="alert alert-info">
                ...
                Phần thống kê sử dụng phương thức hỗ trợ sẽ được hiển thị khi có dữ liệu phiếu hỗ trợ.
            </div>
        </div>
    </div>
</div>
