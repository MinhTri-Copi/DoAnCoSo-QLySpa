...
@section('title', 'Thêm Trạng Thái Quảng Cáo Mới')
...
@section('content')
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Thêm Trạng Thái Quảng Cáo Mới</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-plus-circle"></i>
                Tạo trạng thái quảng cáo mới trong hệ thống
            </p>
        </div>
    </div>
        ...
        <div class="spa-content-body">
            <div class="spa-info-block">
                ...
                <p class="spa-info-block-text">
                    Tạo trạng thái quảng cáo mới để quản lý trạng thái của các quảng cáo trong hệ thống. Mã trạng thái được sinh tự động, bạn chỉ cần nhập tên trạng thái.
                </p>
            </div>
