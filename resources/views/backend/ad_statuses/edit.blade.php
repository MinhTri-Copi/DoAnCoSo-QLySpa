...
@section('title', 'Chỉnh Sửa Trạng Thái Quảng Cáo')
...
@section('content')
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Chỉnh Sửa Trạng Thái Quảng Cáo</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-edit"></i>
                Cập nhật thông tin trạng thái {{ $status->TenTT }} (Mã: {{ $status->MaTTQC }})
            </p>
        </div>
    </div>
    ...
    <div class="spa-content-wrapper">
        ...
        @endif
            ...
            <form action="{{ route('admin.ad-statuses.update', $status->MaTTQC) }}" method="POST" class="spa-form">
            @csrf
            @method('PUT')
                ...
                <input type="text" class="form-control" value="{{ $status->MaTTQC }}" disabled>
                            <div class="help-text">Mã trạng thái không thể thay đổi sau khi đã tạo</div>
                        </div>
            </div>
                ...
                <input type="text" name="TenTT" class="form-control" value="{{ old('TenTT', $status->TenTT) }}" required>
                            <div class="help-text">Nhập tên mô tả trạng thái quảng cáo</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="spa-btn-group">
                    ...
                    <a href="{{ route('admin.ad-statuses.show', $status->MaTTQC) }}" class="spa-btn spa-btn-secondary">
