...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Thêm Trạng Thái Mới</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-plus-circle"></i>
                Tạo trạng thái mới trong hệ thống
            </p>
        </div>
        </div>
        ...
        <div class="spa-content-body">
            <div class="spa-info-block">
                ...
                <p class="spa-info-block-text">
                    Tạo trạng thái mới để quản lý các quy trình trong hệ thống. Trạng thái giúp xác định tình trạng của các đối tượng như đang xử lý, hoàn thành, bị hủy, v.v.
                </p>
            </div>
            ...
            <form action="{{ route('admin.trangthai.store') }}" method="POST" class="spa-form">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Matrangthai" class="form-control" value="{{ $suggestedMaTT ?? '' }}" readonly>
                            <div class="help-text">Mã trạng thái sẽ được tạo tự động</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="help-text">Nhập tên trạng thái (vd: Đã thanh toán, Đang xử lý, Hoàn thành...)</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="spa-btn-group">
                    ...
                    <a href="{{ route('admin.trangthai.index') }}" class="spa-btn spa-btn-secondary">
