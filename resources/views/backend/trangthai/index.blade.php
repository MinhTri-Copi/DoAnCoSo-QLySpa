...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Quản Lý Trạng Thái</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-tags"></i>
                Thiết lập và quản lý các trạng thái trong hệ thống
            </p>
        </div>
        <div class="spa-header-action">
            <a href="{{ route('admin.trangthai.create') }}" class="spa-btn-add">
    ...
    <div class="spa-content-wrapper">
        ...
        <div class="spa-content-body">
            <div class="spa-search-box">
                ...
                <input type="text" placeholder="Tìm kiếm trạng thái..." id="searchInput">
            </div>
            ...
            @if($trangThais->isEmpty())
                <div class="spa-empty-state">
                    <i class="fas fa-tags spa-empty-icon"></i>
                    <h3 class="spa-empty-title">Chưa có trạng thái nào</h3>
                    <p class="spa-empty-desc">Hệ thống chưa có trạng thái nào được thiết lập. Bạn có thể tạo trạng thái mới để quản lý hệ thống.</p>
                    <a href="{{ route('admin.trangthai.create') }}" class="spa-btn-add">
                        <i class="fas fa-plus"></i>
                        Thêm Trạng Thái Mới
                    </a>
                        ...
                        @foreach($trangThais as $trangThai)
                            <tr>
                                <td class="text-center">
                                    <span class="spa-status-id">{{ $trangThai->Matrangthai }}</span>
                                </td>
                                <td>
                                    <div class="spa-status-name">{{ $trangThai->Tentrangthai }}</div>
                                    <span class="spa-status-code">Mã: {{ $trangThai->Matrangthai }}</span>
                                </td>
                                <td>
                                    <div class="spa-actions-wrapper">
                                        <a href="{{ route('admin.trangthai.show', $trangThai->Matrangthai) }}" class="spa-action-btn view" title="Xem chi tiết">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.trangthai.edit', $trangThai->Matrangthai) }}" class="spa-action-btn edit" title="Chỉnh sửa">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('admin.trangthai.confirm-destroy', $trangThai->Matrangthai) }}" class="spa-action-btn delete">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="p-3 rounded-circle mr-3" style="background: rgba(255, 107, 149, 0.1);">
                            <i class="fas fa-tags text-pink" style="color: var(--primary-pink);"></i>
                        </div>
                        <h5 class="m-0 font-weight-bold">Trạng Thái</h5>
                    </div>
                    <p class="text-muted mb-0">Quản lý các trạng thái khác nhau như đã thanh toán, chưa thanh toán, đang xử lý, v.v.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card border-0 h-100 shadow-sm" style="border-radius: var(--radius-md);">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h5 class="m-0 font-weight-bold">Quản Lý Quy Trình</h5>
                    </div>
                    <p class="text-muted mb-0">Theo dõi và cập nhật trạng thái của từng quy trình trong hệ thống.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card border-0 h-100 shadow-sm" style="border-radius: var(--radius-md);">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-0">Tùy chỉnh cách hiển thị và sắp xếp các trạng thái.</p>
                </div>
            </div>
        </div>
    </div>
