...
@section('title', 'Chỉnh Sửa Trạng Thái')
...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Chỉnh Sửa Trạng Thái</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-edit"></i>
                Cập nhật thông tin trạng thái: {{ $trangThai->Tentrangthai }}
            </p>
        </div>
    </div>
        ...
        <div class="spa-content-body">
            <div class="spa-info-block">
                ...
                <p class="spa-info-block-text">
                    Bạn đang chỉnh sửa trạng thái. Hãy cập nhật thông tin trạng thái với tên trạng thái phù hợp.
                </p>
            </div>
            ...
            <form action="{{ route('admin.trangthai.update', $trangThai->Matrangthai) }}" method="POST" class="spa-form">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Tentrangthai" class="form-control" value="{{ old('Tentrangthai', $trangThai->Tentrangthai) }}" required>
                            <div class="help-text">Nhập tên mô tả trạng thái (vd: Đã thanh toán, Đang xử lý, Hoàn thành...)</div>
                        </div>
                    </div>
        </div>
