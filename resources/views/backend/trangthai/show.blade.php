...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">{{ $trangThai->Tentrangthai }}</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-tag"></i>
                Mã trạng thái: {{ $trangThai->Matrangthai }}
            </p>
        </div>
        <div class="spa-header-actions">
            ...
            <a href="{{ route('admin.trangthai.confirm-destroy', $trangThai->Matrangthai) }}" class="spa-action-btn delete" title="Xóa">
    ...
    <div class="spa-back-section">
        <a href="{{ route('admin.trangthai.index') }}" class="spa-back-btn">
                    ...
                    <div class="spa-info-card">
                        ...
                        <div class="spa-info-item">
                            ...
                            <span class="spa-info-value">
                                <span class="spa-info-badge badge-primary">{{ $trangThai->Matrangthai }}</span>
                            </span>
                        </div>
                        <div class="spa-info-item">
                            <span class="spa-info-label">Tên Trạng Thái:</span>
                            <span class="spa-info-value">{{ $trangThai->Tentrangthai }}</span>
                        </div>
                    </div>

                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.trangthai.edit', $trangThai->Matrangthai) }}" class="spa-btn spa-btn-primary">
                            <i class="fas fa-edit"></i>
                            Chỉnh Sửa
                        </a>
                        <a href="{{ route('admin.trangthai.confirm-destroy', $trangThai->Matrangthai) }}" class="spa-btn spa-btn-danger">
                            <i class="fas fa-trash"></i>
                            Xóa
                        </a>
                    </div>
            ...
            <div class="spa-content-wrapper">
                ...
                <div class="spa-content-body">
                    <div class="alert alert-info">
                        ...
                        <strong>Trạng thái</strong> là thông tin về tình trạng của các đối tượng trong hệ thống. Các trạng thái phổ biến bao gồm: Đã thanh toán, Chưa thanh toán, Đang xử lý, Hoàn thành.
                    </div>
                    <p class="mt-4">
                        Để quản lý hệ thống hiệu quả, bạn nên:
                    </p>
                    <ul>
                        <li>Đảm bảo cập nhật trạng thái thường xuyên</li>
                        <li>Theo dõi luồng trạng thái của các đối tượng</li>
                        <li>Theo dõi số lượng đối tượng theo từng trạng thái</li>
                        <li>Tối ưu hóa quy trình dựa trên thống kê trạng thái</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="spa-content-wrapper mb-4">
        ...
        <div class="spa-content-body">
            <div class="alert alert-info">
                ...
                Phần thống kê theo trạng thái sẽ được hiển thị khi có dữ liệu liên quan.
            </div>
        </div>
    </div>
</div>
