...
@section('content')
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Chỉnh Sửa Trạng Thái Phòng</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-edit"></i>
                Cập nhật thông tin trạng thái phòng: {{ $trangThaiPhong->Tentrangthai }}
            </p>
        </div>
        </div>
        ...
        <div class="spa-content-body">
            <div class="spa-info-block">
                ...
                <p class="spa-info-block-text">
                    Bạn đang chỉnh sửa trạng thái phòng. Hãy cập nhật thông tin trạng thái với tên trạng thái phù hợp.
                </p>
            </div>
            ...
            <form action="{{ route('admin.trangthaiphong.update', $trangThaiPhong->MatrangthaiP) }}" method="POST" class="spa-form">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="MatrangthaiP" class="form-control" value="{{ old('MatrangthaiP', $trangThaiPhong->MatrangthaiP) }}" readonly>
                            <div class="help-text">Mã trạng thái phòng hiện tại (không thể thay đổi)</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Tentrangthai" class="form-control" value="{{ old('Tentrangthai', $trangThaiPhong->Tentrangthai) }}" required>
                            <div class="help-text">Nhập tên mô tả trạng thái phòng (vd: Còn trống, Đang sử dụng, Đang bảo trì...)</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="spa-btn-group">
                    ...
                    <a href="{{ route('admin.trangthaiphong.index') }}" class="spa-btn spa-btn-secondary">
