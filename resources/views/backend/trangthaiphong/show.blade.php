...
@section('content')
<div class="container">
    <h2 class="mb-4">Chi Tiết Trạng Thái Phòng</h2>
    <div class="mb-3">
        <label class="form-label">Mã Trạng Thái Phòng:</label>
        <p>{{ $trangThaiPhong->MatrangthaiP }}</p>
    </div>

    <div class="mb-3">
        <label class="form-label">Tên Trạng Thái:</label>
        <p>{{ $trangThaiPhong->Tentrangthai }}</p>
    </div>
