...
@section('title', 'Thêm Trạng Thái Phòng Mới')
...
@section('content')
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Thêm Trạng Thái Phòng Mới</h1>
    ...
    <div class="spa-content-wrapper">
        ...
        <div class="spa-content-body">
            <div class="spa-info-block">
                ...
                <p class="spa-info-block-text">
                    Tạo trạng thái phòng mới để quản lý các phòng trong hệ thống. Trạng thái phòng giúp xác định tình trạng của phòng như đang sử dụng, còn trống, đang bảo trì, v.v.
                </p>
            </div>
        ...
        <!-- Form thêm trạng thái -->
            <form action="{{ route('admin.trangthaiphong.store') }}" method="POST" class="spa-form">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="MatrangthaiP" class="form-control" value="{{ $suggestedMaTTP ?? '' }}" readonly>
                            <div class="help-text">Mã trạng thái phòng sẽ được tạo tự động</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Tentrangthai" class="form-control" value="{{ old('Tentrangthai') }}" required>
                            <div class="help-text">Nhập tên trạng thái phòng (vd: Còn trống, Đang sử dụng, Đang bảo trì...)</div>
                        </div>
                    </div>
                </div>
