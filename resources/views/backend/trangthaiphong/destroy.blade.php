...
<div class="container-fluid">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Xác Nhận Xóa Trạng Thái Phòng</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-exclamation-triangle"></i>
                Xóa trạng thái phòng sẽ không thể hoàn tác
            </p>
        </div>
    </div>
        ...
        <div class="spa-content-body">
            <div class="spa-warning-card">
                ...
                <p class="spa-warning-text">
                    Bạn đang chuẩn bị xóa trạng thái phòng này. Hành động này không thể hoàn tác. Các phòng đang sử dụng trạng thái này có thể bị ảnh hưởng.
                </p>
            </div>
            ...
            <div class="spa-info-card">
                ...
                <div class="spa-info-item">
                    ...
                    <span class="spa-info-value">{{ $trangThaiPhong->MatrangthaiP }}</span>
                </div>
                <div class="spa-info-item">
