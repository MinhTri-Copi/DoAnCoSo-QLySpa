...
<div class="container">
    ...
    <div class="spa-dashboard-header">
        ...
        <div class="spa-header-content">
            <h1 class="spa-header-title">Thêm Phòng Mới</h1>
            <p class="spa-header-subtitle">
                <i class="fas fa-plus-circle"></i> Tạo phòng mới trong hệ thống Spa
            </p>
        </div>
    ...
    <div class="spa-content-wrapper">
        ...
        <div class="spa-content-body">
            ...
            <form action="{{ route('admin.phong.store') }}" method="POST" class="spa-form">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                ...
                                id="Maphong" 
                                name="Maphong" 
                                value="{{ $suggestedMaphong }}" 
                                readonly>
                            <p class="help-text">Mã phòng được tạo tự động.</p>
                            @error('Maphong')
