...
@section('title', 'Sự kiện - ROSA SPA')

@section('content')
<div class="container py-5">
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-4 p-md-5 rounded-lg mb-5">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="display-5 fw-bold mb-2">Sự kiện nổi bật</h1>
                <p class="lead mb-0">Theo dõi các sự kiện đặc biệt tại ROSA SPA</p>
            </div>
    ...
    @else
        ...
        <div class="text-center py-5">
            <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 100px; height: 100px;">
                <i class="fas fa-calendar-alt text-secondary fa-3x"></i>
            </div>
            <h3 class="h4 fw-bold text-muted mb-2">Không có sự kiện nào</h3>
