...
@section('title', 'Quảng cáo nổi bật - ROSA SPA')

@section('content')
<div class="container py-5">
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-amber-500 to-yellow-400 text-white p-4 p-md-5 rounded-lg mb-5">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="display-5 fw-bold mb-2">Quảng cáo nổi bật</h1>
                <p class="lead mb-0">Những thông tin quan trọng nhất từ ROSA SPA</p>
            </div>
    ...
    @else
        ...
        <div class="text-center py-5">
            <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 100px; height: 100px;">
                <i class="fas fa-star text-secondary fa-3x"></i>
            </div>
            <h3 class="h4 fw-bold text-muted mb-2">Không có quảng cáo nổi bật</h3>
            <p class="text-muted">Hiện tại không có quảng cáo nổi bật nào để hiển thị.</p>
