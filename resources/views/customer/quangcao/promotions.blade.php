...
@section('title', 'Khuyến mãi - ROSA SPA')

@section('content')
<div class="container py-5">
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-pink-500 to-red-500 text-white p-4 p-md-5 rounded-lg mb-5">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="display-5 fw-bold mb-2">Khuyến mãi đặc biệt</h1>
                <p class="lead mb-0">Những ưu đãi hấp dẫn nhất dành riêng cho bạn</p>
            </div>
            <div class="col-md-4 d-flex align-items-center justify-content-end">
                <i class="fas fa-percent fa-4x opacity-75"></i>
            </div>
        </div>
    </div>
    ...
    @else
        ...
        <div class="text-center py-5">
            <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 100px; height: 100px;">
                <i class="fas fa-percent text-secondary fa-3x"></i>
            </div>
            <h3 class="h4 fw-bold text-muted mb-2">Không có khuyến mãi nào</h3>
            <p class="text-muted">Hiện tại không có khuyến mãi nào đang diễn ra.</p>
